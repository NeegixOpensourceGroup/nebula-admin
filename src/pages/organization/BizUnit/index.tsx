            ...
            >
              <ProFormRadio.Group
                ...
                label={intl.formatMessage({
                  id: 'layout.organization.bizUnit.type.title',
                })}
                name="type"
                tooltip={
                  <FormattedMessage id="layout.organization.bizUnit.type.tooltip" />
                }
                rules={[
                  {
                    required: true,
                ...
                options={[
                  {
                    label: (
                      <FormattedMessage id="layout.organization.bizUnit.type.headquarter" />
                    ),
                    value: 1,
                  ...
                  {
                    label: (
                      <FormattedMessage id="layout.organization.bizUnit.type.branch" />
                    ),
                    value: 2,
                  ...
                  {
                    label: (
                      <FormattedMessage id="layout.organization.bizUnit.type.external" />
                    ),
                    value: 3,
                    disabled: formStatus === FormStatus.CREAT_ROOT,
                  },
              ...
              <ProFormText
                ...
                name="abbreviation"
                label={
                  <FormattedMessage id="layout.organization.bizUnit.abbreviation" />
                }
              />
              <ProFormText
                colProps={{ span: 12 }}
                ...
                name="tel"
                label={
                  <FormattedMessage id="layout.organization.bizUnit.tel" />
                }
              />
              <ProFormText
                colProps={{ span: 12 }}
